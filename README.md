...
2. Create the following resources, which are shown in the pdf file [demo-stack-diagram.pdf](./demo-stack-diagram.pdf)
...
3. Make sure to use the following variables in your terraform code:
...
4. Configure the route tables, security lists, and network security groups:
...
7. Create modules of the different resources that you are using. Grading will also be done based on how modularized and reusable your code is.
...
2.  On the public instance, `ic_pub_vm-A`, Create two groups named privileged and unprivileged. Add two users named admin and guest. Place the guest user in the unprivileged group and admin user in the privileged group.
